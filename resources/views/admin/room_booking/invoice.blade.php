...
<html>
	...
	<body>
		...
		<a id ="printbtn" href="{{ url('admin/room_booking') }}" class="btn" style="background-color:#C5C20B;color:white">Back</a>
			...
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="information">
                    ...
                    <table class="table table-bordered table-striped">
                        <thead style="background-color:#2E2D2B;color:white">
                            <th>No.</th>
                            <th>Tipe Kamar</th>
							<th>Extra Bed</th>
                            <th>Check-in</th>
                    ...
                    <table class="table  table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center; background-color:#4C4A47;color:white">Amount</td>
                            ...
                            <tr>
                                ...
                                <td style="width:400px; border:1px solid white; background-color:white"></td>
                                <td style="text-align:center; background-color:#4C4A47;color:white">Grand total</td>
