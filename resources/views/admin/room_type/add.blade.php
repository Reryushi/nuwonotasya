                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="integer" class="form-control border-input" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage')  }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="extra_bed" id="extra_bed" class="form-control">
                                            <option value="2"
                                                    @if (Input::old('extra_bed') == '2') selected="selected" @endif>2
                                            </option>
                                            <option value="1"
                                                    @if (Input::old('extra_bed') == '1') selected="selected" @endif>
                                                1
                                            </option>
                                        </select>
                                    </div>
